  ...
  return (
    <div>
      ...
      <SwitchItem
        ...
        onChange={() => updateSetting("manualTheming", !getSetting("manualTheming", false))}
      >
      ...
      <Category
          ...
          onChange={() =>
            updateSetting(
              "designSettings",
              !getSetting("designSettings", false)
            )
          }
        >
          <ColorPickerInput
            note={"The visualizers color when your status is 'Online'."}
            onChange={(value) => updateSetting("color-online", _numberToHex(value))}
          ...
          <ColorPickerInput
            ...
            onChange={(value) => updateSetting("color-invisible", _numberToHex(value))}
      ...
      >
        ...
        <div>
          Online: #{getSetting("color-online", "1ed860")}<br />
          Idle: #{getSetting("color-idle", "d8d51e")}<br />
          Do Not Disturb: #{getSetting("color-dnd", "d81e1e")}<br />
