...
module.exports = class PSpectrum {
  ...
  _hasBass(data) { 
    return (
      ...
      // Mid Bass
      ((this._normalize_buffer[4] * 1.6 <= data[4] && this._normalize_buffer[5] * 1.6 <= data[5]) && (data[4] >= 0.0132 && data[5] >= 0.010 && data[6] >= 0.010)) 
      
      &&

      // Low Bass
      ((this._normalize_buffer[1] * 1.6 <= data[1] && this._normalize_buffer[2] * 1.6 <= data[2]) && (data[1] >= 0.0132 && data[2] >= 0.010 && data[3] >= 0.010))
    );
  }
